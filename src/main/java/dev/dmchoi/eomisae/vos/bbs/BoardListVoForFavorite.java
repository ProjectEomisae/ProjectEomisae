...
public class BoardListVoForFavorite extends BoardEntity implements IResult<BoardListResult> {
    ...
    public BoardListVoForFavorite setArticles(List<BoardListArticleDto> articles) {
