...
public class BoardListVoForEv extends BoardEntity implements IResult<BoardListResult> {
    ...
    public BoardListVoForEv setArticles(List<BoardListArticleDto> articles) {
