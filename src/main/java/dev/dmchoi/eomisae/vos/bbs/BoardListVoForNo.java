...
public class BoardListVoForNo extends BoardEntity implements IResult<BoardListResult> {
    ...
    public BoardListVoForNo setArticles(List<BoardListArticleDto> articles) {
