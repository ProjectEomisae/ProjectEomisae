...
public class BoardListVoForDailyImage extends BoardEntity implements IResult<BoardListResult> {
    ...
    public BoardListVoForDailyImage setArticles(List<BoardListArticleDto> articles) {
