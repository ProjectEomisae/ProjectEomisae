...
public class BoardListVoForRealImage extends BoardEntity implements IResult<BoardListResult> {
    ...
    public BoardListVoForRealImage setArticles(List<BoardListArticleDto> articles) {
